...
/* $Id: mixer.d,v 1.1 2005/04/24 12:05:39 afb Exp $ */
...
*/
const uint SDL_MIXER_MAJOR_VERSION	= 1;
const uint SDL_MIXER_MINOR_VERSION	= 2;
const uint SDL_MIXER_PATCHLEVEL	= 6;

/* This macro can be used to fill a version structure with the compile-time
 * version of the SDL_mixer library.
 */
void SDL_MIXER_VERSION(out SDL_version X)
{
...
alias SDL_MIXER_PATCHLEVEL		MIX_PATCHLEVEL;
...
const uint MIX_CHANNELS	= 8;

/* Good default values for a PC soundcard */
const uint MIX_DEFAULT_FREQUENCY	= 22050;
version (LittleEndian)
const uint MIX_DEFAULT_FORMAT	= AUDIO_S16LSB;
else
const uint MIX_DEFAULT_FORMAT	= AUDIO_S16MSB;

const uint MIX_DEFAULT_CHANNELS	= 2;
const uint MIX_MAX_VOLUME		= 128;	/* Volume of a chunk */
...
version (USE_RWOPS) { /* This hasn't been hooked into music.c yet */
 ...
 */
alias void (*Mix_EffectFunc_t)(int chan, void *stream, int len, void *udata);
 ...
 * DO NOT EVER call SDL_LockAudio() from your callback function!
 */
alias void (*Mix_EffectDone_t)(int chan, void *udata);
