...
alias int (*_seek_func_t)(SDL_RWops *context, int offset, int whence);
alias int (*_read_func_t)(SDL_RWops *context, void *ptr, int size, int maxnum);
alias int (*_write_func_t)(SDL_RWops *context, void *ptr, int size, int num);
alias int (*_close_func_t)(SDL_RWops *context);
...
int SDL_RWtell(SDL_RWops *ctx)
{
	...
	return ctx.seek(ctx, 0, SEEK_CUR);
}
